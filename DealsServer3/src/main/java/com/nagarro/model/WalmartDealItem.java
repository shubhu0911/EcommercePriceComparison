...
public class WalmartDealItem {
	...
	private Image image;
	@Embedded
	@AttributeOverrides({ @AttributeOverride(name = "value", column = @Column(name = "marketing_original_value")),
			@AttributeOverride(name = "currency", column = @Column(name = "marketing_original_currency")) })
	private MarketingPrice marketingPrice;
	@Embedded
	@AttributeOverrides({ @AttributeOverride(name = "value", column = @Column(name = "price_value")),
